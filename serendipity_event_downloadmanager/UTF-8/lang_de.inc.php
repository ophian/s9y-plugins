<?php # $Id: lang_de.inc.php, german lang file <de-utf8> v. 1.12 - 2010-09-22 ian (Timbalu) Exp $
...
@define('PLUGIN_DOWNLOADMANAGER_SHOWHIDDEN_REGISTERED_BLAHBLAH', 'Sollen versteckte Kategorien für registrierte und eingeloggte User im Frontend sichtbar sein?');
...
@define('PLUGIN_DOWNLOADMANAGER_INCOMINGTABLE_BLAHBLAH', 'Dies ermöglicht den einzelnen/multiplen Import von per FTP hochgeladenen Dateien<br />oder die vollständige Löschung einzelner/aller hierhin verschobener Dateien (siehe blaues Trash Symbol).<br />Current directory: ');
...
@define('PLUGIN_DOWNLOADMANAGER_MEDIA_LIBRARY_BLAHBLAH', 'Hier können bereits hochgeladene Dateien aus der Mediendatenbank in den Downloadmanager importiert werden.<br />Diese Dateien werden nicht verschoben, sondern nur kopiert!<br />Aktuelles Verzeichnis: ');
