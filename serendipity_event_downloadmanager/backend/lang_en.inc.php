<?php # $Id: lang_en.inc.php, english lang file <en> v. 1.13 - 2010-09-08 ian (Timbalu) Exp $
...
/*
@define('PLUGIN_DOWNLOADMANAGER_HELPTIP_IF_S9ML', 'Please avoid using the S9y Media Library having files in ftp/trash folder.<br />&nbsp;&nbsp;&nbsp;They would get created as new files and truly be erased, as deleted in here.');
*/
