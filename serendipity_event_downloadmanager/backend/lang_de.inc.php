<?php # $Id: lang_de.inc.php, german lang file <de> v. 1.12 - 2010-09-08 ian (Timbalu) Exp $
...
@define('PLUGIN_DOWNLOADMANAGER_HELPTIP_CF_CHANGE', 'Kategorien Name im Feld selbst ändern / <em>Enter</em>');
...
/*
@define('PLUGIN_DOWNLOADMANAGER_HELPTIP_IF_S9ML', 'Vermeiden Sie die Benutzung der Mediendatenbank, wenn Sie Dateien im ftp/trash Verzeichnis<br />&nbsp;&nbsp;&nbsp;haben. Sie nähme sie als neue Dateien, entfernte sie aber auch wieder, falls hier gelöscht.');
*/
