<?php # $Id: serendipity_event_downloadmanager.php, v.0.28 - 2011-03-04 14:43 ian
...
class serendipity_event_downloadmanager extends serendipity_event {
    ...
    **/    
    ...
    function fetchTemplatePath($filename) { 
        ...
        // be smarty 3 compat including the serendipity_smarty class wrappers ->fetch and ->display methods and remove unused parameters
    ...
    function event_hook($event, &$bag, &$eventData) {
        ...
        // can we still keep this here? (in guestbook and eventcal this place still disrupted entry comments form, why?)
